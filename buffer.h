...
static inline bijson_error_t _bijson_buffer_append_byte(_bijson_buffer_t *buffer, byte byte) {
	return _bijson_buffer_append(buffer, &byte, sizeof byte);
}

static inline bijson_error_t _bijson_buffer_append_size(_bijson_buffer_t *buffer, size_t size) {
	return _bijson_buffer_append(buffer, &size, sizeof size);
}
