...
static bool _bijson_container_push(bijson_writer_t *writer) {
...
static bool _bijson_container_pop(bijson_writer_t *writer) {
...
bool _bijson_writer_write_object(bijson_writer_t *writer, _bijson_writer_write_func_t write, void *write_data, const char *spool) {
...
bool _bijson_writer_write_array(bijson_writer_t *writer, _bijson_writer_write_func_t write, void *write_data, const char *spool) {
	_bijson_container_t container;
	memcpy(&container, spool, sizeof container);
	spool += sizeof container;
